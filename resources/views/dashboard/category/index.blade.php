            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                    ...
                    <td class="px-6 py-4 flex gap-2">
                        <form action="/dashboard/category/{{ $category->slug }}" method="POST" class="text-red-500 hover:text-red-700 transition">
                            @csrf
                            @method('DELETE')
                        ...
                        <div class="text-yellow-600 hover:text-yellow-700 transition">
                            <a href="/dashboard/category/{{ $category->slug }}/edit"><i class="fa-sharp fa-solid fa-edit"></i>Edit</a>
                        </div>
                    </td>
                </tr>
                @endforeach
